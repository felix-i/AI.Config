...
* E2E testing: obsess over pixel perfection. Fix UI flaws found along the way.
* Engineering excellence: fix lint, test failures, and flakiness immediately.
* Dynamic workflows or subagent swarms: explain tradeoffs and get explicit approval first.
